...
```markdown
![写真](images/photo.png){width=50%}
![図解](images/diagram.png){width=300px height=200px}
![ロゴ](images/logo.png){width=100px align=center}
![バナー](images/banner.png){max-width=600px align=right}
```
...
| 属性 | 説明 | 例 |
|------|------|-----|
| `width` | 幅を指定 | `width=50%`, `width=300px` |
| `height` | 高さを指定 | `height=200px` |
| `max-width` | 最大幅を指定 | `max-width=600px` |
| `max-height` | 最大高さを指定 | `max-height=400px` |
| `align` | 配置を指定 | `align=left`, `align=center`, `align=right` |
...
MDebook v0.8.1ではpdfmakeによるネイティブPDF生成機能を搭載しています。
